export default function SettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      <div className="w-16 h-16 rounded-2xl bg-slate-500/10 dark:bg-slate-500/15 flex items-center justify-center mb-4">
      ...
      <p className="text-slate-500 dark:text-slate-400 max-w-sm">
        Settings configuration is coming soon. Screenshots incoming.
      </p>
    </div>
  );
}
